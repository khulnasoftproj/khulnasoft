...
import (
	...
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/cargo"
	...
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/allowpolicy"
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/cp"
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/denypolicy"
	cexec "github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/exec"
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/generate"
	genrgst "github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/generate-registry"
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/generate/output"
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/info"
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/initcmd"
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/initpolicy"
	...
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/updatechecksum"
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/updatekhulnasoft"
	...
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/link"
...
func InitializeUpdateKhulnasoftCommandController(ctx context.Context, param *config.Param, httpClient *http.Client, rt *runtime.Runtime) *updatekhulnasoft.Controller {
	wire.Build(
		updatekhulnasoft.New,
		wire.NewSet(
			afero.NewOsFs,
			wire.Bind(new(installpackage.Cleaner), new(afero.Fs)),
		),
		wire.NewSet(
			github.New,
			wire.Bind(new(github.RepositoriesService), new(*github.RepositoriesServiceImpl)),
			wire.Bind(new(updatekhulnasoft.RepositoriesService), new(*github.RepositoriesServiceImpl)),
		),
		wire.NewSet(
			installpackage.New,
			wire.Bind(new(updatekhulnasoft.KhulnasoftInstaller), new(*installpackage.InstallerImpl)),
		),
		download.NewHTTPDownloader,
		wire.NewSet(
			download.NewDownloader,
	...
	return &updatekhulnasoft.Controller{}
}
