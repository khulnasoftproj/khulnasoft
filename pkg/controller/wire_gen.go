...
import (
	...
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/config-finder"
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/config-reader"
	...
	exec2 "github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/exec"
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/generate"
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/controller/generate-registry"
	...
	"github.com/khulnasoftproj/khulnasoft/v2/pkg/install-registry"
...
func InitializeUpdateKhulnasoftCommandController(ctx context.Context, param *config.Param, httpClient *http.Client, rt *runtime.Runtime) *updatekhulnasoft.Controller {
	...
	cargoPackageInstallerImpl := installpackage.NewCargoPackageInstallerImpl(executor, fs)
	installerImpl := installpackage.New(param, downloader, rt, fs, linker, checksumDownloaderImpl, calculator, unarchiverImpl, checker, verifierImpl, slsaVerifierImpl, goInstallInstallerImpl, goBuildInstallerImpl, cargoPackageInstallerImpl)
	controller := updatekhulnasoft.New(param, fs, rt, repositoriesService, installerImpl)
	return controller
}
