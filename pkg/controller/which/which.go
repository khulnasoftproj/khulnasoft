...
func (ctrl *ControllerImpl) Which(ctx context.Context, logE *logrus.Entry, param *config.Param, exeName string) (*FindResult, error) {
	...
	return nil, logerr.WithFields(errCommandIsNotFound, logrus.Fields{ //nolint:wrapcheck
		"exe_name": exeName,
		"doc":      "https://khulnasoftproj.github.io/docs/reference/codes/004",
	})
}
...
func (ctrl *ControllerImpl) findExecFileFromPkg(registries map[string]*registry.Config, exeName string, pkg *khulnasoft.Package, logE *logrus.Entry) *FindResult { //nolint:cyclop
