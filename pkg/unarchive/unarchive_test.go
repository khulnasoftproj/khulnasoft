...
func TestUnarchiver_Unarchive(t *testing.T) {
	...
	data := []struct {
	...
	}{
		{
			title: "raw",
			src: &unarchive.File{
				Filename: "khulnasoft-installer",
			},
			body: `foo`,
		},
		{
			title: "tarball",
			url:   "https://github.com/sulaiman-coder/archives-for-test/raw/main/README.md.tar.gz",
			src: &unarchive.File{
		...
		{
			title: "decompressor",
			url:   "https://github.com/sulaiman-coder/archives-for-test/raw/main/README.md.bz2",
			src: &unarchive.File{
