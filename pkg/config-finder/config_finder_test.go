...
func Test_configFinderFind(t *testing.T) { //nolint:funlen
	...
	data := []struct {
		...
		},
		{
			name:           "configFilePath",
			wd:             "/home/foo",
			configFilePath: "/home/foo/khulnasoft.yaml",
			exp:            "/home/foo/khulnasoft.yaml",
		},
		{
			name: "find",
			wd:   "/home/foo",
			files: map[string]string{
				"/home/foo/.khulnasoft.yaml": "",
			},
			exp: "/home/foo/.khulnasoft.yaml",
		},
		{
			...
			wd:   "/home/foo",
			globalConfigFilePaths: []string{
				"/home/.config/khulnasoft.yaml",
				"/etc/khulnasoft/khulnasoft.yaml",
			},
			files: map[string]string{
				"/etc/khulnasoft/khulnasoft.yaml": "",
			},
			exp: "/etc/khulnasoft/khulnasoft.yaml",
		},
	}
	for _, d := range data {
		d := d
...
func Test_configFinderFinds(t *testing.T) {
	...
	data := []struct {
		...
		},
		{
			name:           "configFilePath",
			wd:             "/home/foo",
			configFilePath: "/home/foo/khulnasoft-2.yaml",
			exp:            []string{"/home/foo/khulnasoft-2.yaml"},
		},
		{
			name: "find",
			wd:   "/home/foo",
		...
		},
		{
			...
			wd:             "/home/foo",
			configFilePath: "khulnasoft-2.yaml",
			files: map[string]string{
				"/home/.khulnasoft.yaml": "",
			},
			exp: []string{
				"/home/foo/khulnasoft-2.yaml",
			},
		},
	}
	for _, d := range data {
