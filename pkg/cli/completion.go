...
func (runner *Runner) newCompletionCommand() *cli.Command {
	// https://github.com/khulnasoftproj/khulnasoft/pull/859
...
complete -o bashdefault -o default -o nospace -F _cli_bash_autocomplete khulnasoft`)
	return nil
}
...
compdef _cli_zsh_autocomplete khulnasoft`)
	return nil
}
