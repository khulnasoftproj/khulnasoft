...
func (validator *ValidatorImpl) Warn(logE *logrus.Entry, policyFilePath string, updated bool) error {
	...
	msg := `The policy file is ignored unless it is allowed by "khulnasoft policy allow" command.

$ khulnasoft policy allow "%s"

If you want to keep ignoring the policy file without the warning, please run "khulnasoft policy deny" command.

$ khulnasoft policy deny "%s"
 ...
 `
	...
	logE.WithFields(logrus.Fields{
		...
		"doc":         "https://khulnasoftproj.github.io/docs/reference/codes/003",
