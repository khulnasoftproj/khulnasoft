...
func TestConfigFinderImpl_Find(t *testing.T) { //nolint:funlen
	...
	data := []struct {
		...
		},
		{
			name:           "configFilePath",
			wd:             "/home/foo",
			configFilePath: "/home/foo/bar/khulnasoft-policy.yaml",
			exp:            "/home/foo/bar/khulnasoft-policy.yaml",
			files: map[string]string{
				"/home/foo/bar/khulnasoft-policy.yaml": "",
			},
		},
		{
			name: "find",
			wd:   "/home/foo/bar",
			files: map[string]string{
				"/home/foo/khulnasoft/khulnasoft-policy.yaml": "",
			},
			dirs: map[string]struct{}{
				"/home/foo/.git": {},
			},
			exp: "/home/foo/khulnasoft/khulnasoft-policy.yaml",
		},
	}
	for _, d := range data {
		d := d
