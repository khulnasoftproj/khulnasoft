...
func getPkgInfoFromRegistries(logE *logrus.Entry, registries map[string]*registry.Config, pkg *khulnasoft.Package, m map[string]map[string]*registry.PackageInfo) (*registry.PackageInfo, error) {
